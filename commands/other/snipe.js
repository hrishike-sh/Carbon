...
module.exports = {
  ...
  async execute(message, args, client) {
    ...
    let snipeBed = new MessageEmbed().setAuthor(msg.author.tag, msg.member.displayAvatarURL() || null).setDescription(msg.content).setColor("RANDOM").setFooter(`${snipe + 1}/${sniped.length}`).setImage(image).setTimestamp(time)
