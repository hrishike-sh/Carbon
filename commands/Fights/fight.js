            ...
            if (msg.author.id === player1 && turnID === player1) {
                ...
                if (!['heal', 'kick', 'punch', 'end'].includes(msg.content.toLowerCase())) {
                    ...
                    if (action === 'punch') {
                        ...
                        let rand = Math.floor(Math.random() * fallChances.length)
                        ...
                        //end
                        collector.stop()
                        return message.channel.send(`<@${player1}> decided to stop the game!`)
                    } else;
                }
                ...
                if (!['heal', 'kick', 'punch', 'end'].includes(msg.content.toLowerCase())) {
                    ...
                    if (action === 'punch') {
                        ...
                        //end
                        collector.stop()
                        return message.channel.send(`<@${player2}> decided to stop the game!`)
                    } else;
                }
            }
