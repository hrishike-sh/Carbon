  ...
  async execute(message, args) {
    ...
    collector.on('collect', async (button) => {
      ...
      if (button.customId === 'myd-d') {
        ...
        buttonH = buttonH.setStyle(ButtonStyle.Secondary).setDisabled(false);
        buttonG = buttonG.setStyle(ButtonStyle.Secondary).setDisabled(false);
        buttonS = buttonS.setStyle(ButtonStyle.Secondary).setDisabled(false);
        ...
        buttonD = buttonD.setStyle(ButtonStyle.Secondary).setDisabled(false);
        buttonG = buttonG.setStyle(ButtonStyle.Secondary).setDisabled(false);
        buttonS = buttonS.setStyle(ButtonStyle.Secondary).setDisabled(false);
